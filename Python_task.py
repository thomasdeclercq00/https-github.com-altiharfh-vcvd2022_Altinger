...
µ = 0.05 # Dynamic friction coefficient, rubber wheels, wet road, aquaplaning (used if coefficient selection not used)
...
#selection of the actual friction coefficient
u = u_array[road_type_array.index(road_type)][road_condition_array.index(road_condition)]
...
# Show, export the figure and results
